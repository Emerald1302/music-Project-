...
def display_search_results(prev_window, title, results):
    ...
    tk.Label(header_frame, text="Song Title", font=("Helvetica", 12, "bold")).grid(row=0, column=0, padx=5)
    tk.Label(header_frame, text="Singer", font=("Helvetica", 12, "bold")).grid(row=0, column=1, padx=5)
    tk.Label(header_frame, text="Genre", font=("Helvetica", 12, "bold")).grid(row=0, column=2, padx=5)
    tk.Label(header_frame, text="Duration", font=("Helvetica", 12, "bold")).grid(row=0, column=3, padx=5)
    ...
    listbox_titles.pack(expand=True)
    singer_frame.grid(row=1, column=1)
    listbox_singer.pack(expand=True)
    genre_frame.grid(row=1, column=2)
    listbox_genre.pack(expand=True)
    duration_frame.grid(row=1, column=3)
    listbox_durations.pack(expand=True)
    ...
    button_back = tk.Button(results_page, text="Back", command=lambda: [
